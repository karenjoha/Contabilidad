...
function make_xlsx_lib(XLSX) {
	...
	if (typeof exports !== 'undefined') {
		if (typeof module !== 'undefined' && module.exports) {
			if (typeof jszip === 'undefined') jszip = require('./jszip.js.js');
		}
	}
			...
			switch (y[0].replace(/\w*:/g, "")) {
				...
				case '<u':
					...
					switch (y.val) {
						...
						case 'singlecontabilidad': font.uval = "single-contabilidad"; break;
						case 'doublecontabilidad': font.uval = "double-contabilidad"; break;
					}
				/* falls through */
				case '<u>':
			...
			switch (strip_ns(y[0])) {
				...
				case '<u':
					switch (y.val) {
						...
						case "singlecontabilidad": font.underline = 0x21; break;
						case "doublecontabilidad": font.underline = 0x22; break;
					} break;
