		...
		<div>
			<div class="contenedor">
				...
				<div class="matriculas">
					<?php if ($rol == 1 || $rol == 3 || $usuario == 'MANUELA MUÑOZ') { ?>
						<a class="item" href="matriculas/frontend/">
							<svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="27" height="27" viewBox="0 0 16 16">
								<path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
							</svg>
							<div style="margin-bottom: 2px">Matriculas</div>
						</a>
					<?php } ?>
				</div>
			</div>
