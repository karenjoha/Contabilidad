...
public function mdlRegistro($tabla1, $tabla2, $tabla3, $datos) {
    try {
        ...
        $stmt1 = Conexion::conectar()->prepare("INSERT INTO $tabla1 (fecha_registro, nombre_alum, primer_apellido, segundo_apellido, documento, tipo_documento, lugar_nacimiento, nacionalidad, direccion, barrio, estrato, comuna, celular, segundo_celular, email) VALUES (:fecha_registro, :nombre_alum, :primer_apellido, :segundo_apellido, :documento, :tipo_documento, :lugar_nacimiento, :nacionalidad, :direccion, :barrio, :estrato, :comuna, :celular, :segundo_celular, :email)");
        ...
        $id_alumno = Conexion::conectar()->lastInsertId();

        // Prepara la segunda consulta para insertar datos del acudiente
        $stmt2 = Conexion::conectar()->prepare("INSERT INTO $tabla2 (id_alumno, nombre_acudiente, celular_acudiente, parentesco, tipo_documento_acudiente, documento_acudiente) VALUES (:id_alumno, :nombre_acudiente, :celular_acudiente, :parentesco, :tipo_documento_acudiente, :documento_acudiente)");
        ...
        $stmt3 = Conexion::conectar()->prepare("INSERT INTO $tabla3 (id_alumno, grupo, jornada, periodo_lectivo, procedencia) VALUES (:id_alumno, :grupo, :jornada, :periodo_lectivo, :procedencia)");
    ...
    public function mdlListarRegistros(
        ...
        if ($item == null && $valor == null) {
			...
			INNER JOIN $tabla3 ON $tabla1.id_alumno = $tabla3.id_registro_academico
