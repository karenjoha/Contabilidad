...
if ($rol == 1 || $rol == 3 || $usuario == 'MANUELA MUÑOZ') { ?>
    ...
    <head>
        ...
        <meta name="descripción" content="Terminacion de contratos gestionadministrativa">
        ...
        <div class="inv_index">
            ...
            <div class="btn btn-actions">
                <a href="../../../" class="btn btn-danger btn-lg" <?php if ($_SESSION['rol'] == 27) {
                    ...
                    Atrás</a>&nbsp;
                <a href="formulario/index.php" class="btn btn-success btn-lg" style="display:none" ;>
                <!-- <a href="formulario/index.php" class="btn btn-success btn-lg" style="background: #54a0de; border-color: #54a0de" ;> -->
                    ...
                    registrar factura</a>
                <!-- <a href="formulario/index.php" class="btn btn-success btn-lg" style="display:none" ;> -->
                <a href="../../frontend" class="btn btn-success btn-lg" style="background: #54a0de; border-color: #54a0de" ;>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z" />
                    </svg>&nbsp;
        ...
        <table class="table table-light table-striped" id="terminacion_contratos_table" width="100%" height="100%">
            ...
            <thead>
                <tr>
                    ...
                    <th class="responsive-hidden">ALUMNO</th>
                    <th class="responsive-hidden">TRIMESTRE</th>
                    <th class="responsive-hidden">MATERIA</th>
                    <th class="responsive-hidden">NOTA</th>
                    ...
                    <tr>
                        ...
                        <td class="responsive-hidden">
                            <li class="dropdown" style="list-style: none;">
                                <?php if ($rol != 25) { ?>
                                    <a class="btn btn-primary" href="formulario/index.php?id_calificacion=<?php echo $dato['id_calificacion']; ?>">Gestionar</a>
                                <?php } ?>
                            </li>
                        </td>
                        <!-- BOTÓN ELIMINAR -->
                        <?php if ($rol == 1) { ?>
                            <td class="responsive-hidden">
                                <form method="POST" id="delete<?php echo $dato['id_calificacion']; ?>">
                                    <input type="hidden" value="<?php echo $dato['id_calificacion']; ?>" name="eliminarCalificacion">
                                    <button type="button" class="btn btn-primary btnEliminar" data-id-calificacion="<?php echo $dato['id_calificacion']; ?>">&nbsp;ELIMINAR</button>
                                </form>
                            </td>
                        <?php } ?>
...
<button type="button" class="btn btn-floating btn-lg" id="btn-back-to-top">
  <img src="../../assets/images/svg/arrow_up.png" style="width: auto; height:30px;" />
</button>
        </div>
        ...
        <script src="assets/js/index_factura.js?v=1.8"></script>
    </body>
