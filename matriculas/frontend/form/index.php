...
if (isset($_SESSION['logged']) === FALSE) {
	header("Location: http://lmzt.online/contabilidad/login.php");
}
        ...
        <form id="form_matricula" method="POST" action="" >
            ...
            <div class="tab-content">
				<div class="tab-pane active" id="form">
					...
					<div class="mb-3">
						...
						<input type='text' class="form-control date-input" readonly value="<?php if (isset($_GET['id'])) {echo $mostrar_fecha;
						} else {
							echo $fecha_registro;
						} ?>" style="text-align: center;" />
						<input type="hidden" name="fecha_registro" value="<?php if (isset($_GET['id'])) {echo $listar['fecha_registro'];
						} else {echo $fecha;} ?>" />
					</div>

					<div class="mb-3">
                        <label for="nombre_alum" class="form-label">Nombres</label>
                        <input name="nombre_alum" type="text" class="form-control" id="nombre_alum" value="<?php if (isset($_GET["id"])) {echo $listar["nombre_alum"];} ?>" >
                    </div>
					<div class="row">
						<div class="col-md-6">
							<div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="lugar_nacimiento" type="text" class="form-control" id="lugar_nacimiento" value="<?php if (isset($_GET["id"])) {echo $listar["lugar_nacimiento"];} else {echo "";} ?>">
                    </div>
                    <div class="mb-3">
                        <label for="nacionalidad" class="form-label">Nacionalidad</label>
                        <input name="nacionalidad" type="text" class="form-control" id="nacionalidad" value="<?php if (isset($_GET["id"])) {echo $listar["nacionalidad"];} else {echo "";} ?>">
                    </div>
                    <div class="mb-3">
 			           <label for="direccion" class="form-label">Direccion</label>
                        <input type="tel" name="direccion" type="text" class="form-control" id="direccion" value="<?php if (isset($_GET["id"])) {echo $listar["direccion"];} else {echo "";} ?>">
                    </div>
                    <div class="mb-3">
					...
					<div class="mb-3">
                        ...
                        <input name="estrato" type="text" class="form-control" id="estrato" value="<?php if (isset($_GET["id"])) {echo $listar["estrato"];} ?>">
                    </div>
					<div class="mb-3">
                        <label for="comuna" class="form-label">Comuna</label>
                        <input name="comuna" type="text" class="form-control" id="comuna" value="<?php if (isset($_GET["id"])) {echo $listar["comuna"];} ?>">
                    </div>
					<div class="mb-3">
                        <label for="celular" class="form-label">Numero #1</label>
                        <input name="celular" type="text" class="form-control" id="celular" value="<?php if (isset($_GET["id"])) {echo $listar["celular"];} ?>">
                    </div>
					<div class="mb-3">
                        <label for="segundo_celular" class="form-label">Numero #2</label>
                        <input name="segundo_celular" type="text" class="form-control" id="segundo_celular" value="<?php if (isset($_GET["id"])) {echo $listar["segundo_celular"];} ?>">
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" name="email"  class="form-control" id="email" value="<?php if (isset($_GET["id"])) {echo $listar["email"];} ?>">
                    </div>
				</div>
                <!-- ficha medica -->
                <div class="tab-pane" id="form1">
					...
					<div class="mb-3">
                        ...
                        <select type="select" name="grupo" type="text" class="form-control" id="grupo" value="<?php if (isset($_GET["id"])) {echo $listar["grupo"];
                                } ?>">
									<option value=""></option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" name="procedencia" type="text" class="form-control" id="procedencia" value="<?php if (isset($_GET["id"])) {echo $listar["procedencia"];} ?>">
                            </div>
                </div>
                ...
                <div class="tab-pane" id="form2">
					...
					<div class="col container-firmas">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nombre_acudiente" type="text" class="form-control" id="nombre_acudiente" value="<?php if(isset($_GET["id"])) {echo $listar["nombre_acudiente"];} ?>">
                        </div>
	                   <div class="mb-3">
							<label for="celular_acudiente" class="form-label">Celular</label>
                                <input type="tel" name="celular_acudiente" type="text" class="form-control" id="celular_acudiente" value="<?php if (isset($_GET["id"])) {echo $listar["celular_acudiente"];
                                } ?>">
						</div>
			           <div class="mb-3">
							<label for="parentesco" class="form-label">Parentesco</label>
                            <input type="text" name="parentesco" type="text" class="form-control" id="parentesco" value="<?php if (isset($_GET["id"])) {echo $listar["parentesco"];} ?>">
						</div>
							<div class="mb-3">
								<label for="tipo_documento" class="form-label">Tipo de Identificación</label>
								<select name="tipo_documento" class="form-select" id="tipo_documento">
			...
			<div class="d-flex justify-content-center">
						    <a href="../index.php" class="btn btn-danger">Volver</a>
								<button id="botonF2"  type="submit" class="btn btn-primary"><?php if (isset($_GET['id'])) {
