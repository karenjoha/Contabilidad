                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" autocomplete="off" required <?php
                                ...
                                ?> name="documento" id="documento" aria-describedby="helpId" placeholder="" value="<?php if (isset($_GET['id'])) {
                        ...
                        <td colspan="1">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="empleado_registra" id="empleado_registra" type="text">
                                    <option value="<?php echo $usuario; ?>" selected>
                                        <?php echo $usuario; ?>
                                    </option>
                                </select>
                            </div>
