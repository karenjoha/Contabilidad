...
class ModeloFacturas {
    static public function mdlRegistro($tabla1, $datos) {
        ...
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla1(fecha_registro, descripcion, num_factura, empleado_registra, documento, banco) VALUES(:fecha_registro, :descripcion, :num_factura, :empleado_registra, :documento, :banco)");
    ...
    static public function mdlActualizar($tabla1, $datos) {
        ...
        $stmt1 = Conexion::conectar()->prepare("UPDATE $tabla1 SET id_factura=:id_factura, fecha_registro=:fecha_registro, descripcion=:descripcion, num_factura=:num_factura, empleado_registra=:empleado_registra, documento=:documento, banco=:banco WHERE id_factura=:id_factura");
        ...
        $stmt1->bindParam(':banco', $datos['banco'], PDO::PARAM_STR);
        $stmt1->execute() == true;
        $stmt1 = null;
