<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/gestionadministrativa/facturas/backend/controlador/facturas.php";

require_once $_SERVER['DOCUMENT_ROOT'] . "/gestionadministrativa/facturas/backend/modelo/modelo.php";
